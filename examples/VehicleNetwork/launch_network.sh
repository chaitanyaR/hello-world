...
for exe in bcm_node ecm_node adas_node gateway_node ipc_node; do
...
# Node colour codes (ANSI):  32=green 33=yellow 34=blue 35=magenta 36=cyan
...
echo "All 5 nodes started (PIDs: ${PIDS[*]})"
echo "Waiting for completion (~9 seconds)..."
echo ""
